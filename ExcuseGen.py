...
def main():
    ...
    inx=  getRandomParticipantIndex(bootcampParticipants)

    # print person's name who has excuse today.
    name = getPerson(inx,bootcampParticipants)
    print ("The person with an excuse today :" +name)
    #
    # print person's name who has excuse today.
